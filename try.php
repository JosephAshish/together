    ...
    <br><br>
                        ...
                        <input  placeholder="From" name="start_from" id="origin-input" type="text" required="">
                        <br>
                        <input placeholder="Destination" name="destination" type="text" id="destination-input" required="">
                        <br>
                        <input placeholder="Date (YYYY_MM_DD)" name="date" type="date" required="">
                        <br>
                        <input placeholder="Number of Seats needed." name="no_seat_need" type="number" required="">
                        <br>
